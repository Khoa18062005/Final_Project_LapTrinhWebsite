...
<div class="col-lg-10 col-md-9">
    <div class="profile-content">
        ...
        <div class="tab-content" id="ordersTabContent">
            ...
            <div class="empty-state text-center py-5">
                ...
                <p class="text-muted mb-4">
                    <c:choose>
                        ...
                        <c:when test="${param.status == 'processing'}">Bạn chưa có đơn hàng nào đang được vận chuyển</c:when>
                        <c:when test="${param.status == 'shipping'}">Bạn chưa có đơn hàng nào đang chờ giao hàng</c:when>
            ...
            <!-- Order List (Sẽ hiển thị khi có dữ liệu) -->
                                ...
                                <div class="order-actions">
                                    <c:choose>
                                        ...
                                        <c:when test="${order.status == 'processing' or order.status == 'shipping'}">
                                            <a href="${pageContext.request.contextPath}/profile/orders/${order.orderId}"
